...
public class DeleteAlimentacion extends javax.swing.JDialog {
    ...
    public DeleteAlimentacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteAlimentacion(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Id de alimentación");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM alimentacion WHERE id_alimentacion = \'%s\'",name);
