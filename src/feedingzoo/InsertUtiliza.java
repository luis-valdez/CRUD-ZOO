 ...
 * @author Maestro
 */
public class InsertUtiliza extends javax.swing.JDialog {
    /**
    ...
    public InsertUtiliza(java.awt.Frame parent, Database db) {
        super(parent, true);
        initComponents();
        this.db = db;
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        Integer id_comida = Integer.parseInt(txtIDAnimalAlimentado.getText());
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al insertar utiliza.");
