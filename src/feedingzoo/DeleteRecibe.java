...
public class DeleteRecibe extends javax.swing.JDialog {
    ...
    public DeleteRecibe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteRecibe(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT id_animal FROM recibe ORDER BY id_animal";
        ResultSet rs = null;
        try {
    ...
    private void initComponents() {
        ...
        id_animal.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        id_animal.setText("Id de animal");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM recibe WHERE id_animal = \'%s\'",name);
