...
public class DeleteAnimal extends javax.swing.JDialog {
    ...
    public DeleteAnimal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteAnimal(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void initComponents() {
        ...
        nombre_animal.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        nombre_animal.setText("Nombre del animal");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM animal WHERE nombre_animal = \'%s\'",name);
