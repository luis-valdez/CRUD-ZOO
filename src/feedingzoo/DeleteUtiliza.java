...
public class DeleteUtiliza extends javax.swing.JDialog {
    ...
    public DeleteUtiliza(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteUtiliza(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT id_comida FROM utiliza ORDER BY id_comida";
        ResultSet rs = null;
        try {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM utiliza WHERE id_comida = \'%s\'",name);
