...
public class DeleteStaff extends javax.swing.JDialog {
    ...
    public DeleteStaff(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteStaff(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void initComponents() {
        ...
        id_staff.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        id_staff.setText("Id de staff");
